...
export const SIDEBAR_NAV_ITEMS: NavItem[] = [
  ...
  { id: "documents", label: "Documents", href: "/documents", iconName: "documents", isActive: false },
  { id: "reports", label: "Reports", href: "/reports", iconName: "reports", isActive: false },
  { id: "workspace", label: "Workspace Layout", href: "/workspace", iconName: "workspace", isActive: false },
  { id: "history", label: "Activity Feed", href: "/activity", iconName: "history", isActive: false },
