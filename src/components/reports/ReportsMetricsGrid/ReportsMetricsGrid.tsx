...
export const ReportsMetricsGrid: React.FC<ReportsMetricsGridProps> = ({
  ...
  const containerClassName = className ? `${styles.metricsGrid} ${className}` : styles.metricsGrid;

  return (
    <div className={containerClassName}>
      {metrics.map((metric) => {
        const isPositive = metric.isPositive ?? !metric.percentageChange.startsWith("-");
        ...
        return (
          <div key={metric.id} className={styles.metricCard}>
            ...
            <div className={styles.valueRow}>
              ...
              <span className={badgeClassName} aria-label={`Change: ${metric.percentageChange}`}>
