    ...
    <div className={styles.card}>
      <div className={styles.header}>
        ...
        <div className={styles.toggleContainer}>
          <button
            type="button"
            className={`${styles.toggleBtn} ${viewType === "admin" ? styles.toggleActive : ""}`}
          ...
          <button
            type="button"
            className={`${styles.toggleBtn} ${viewType === "member" ? styles.toggleActive : ""}`}
              ...
              <div key={adm.id} className={styles.itemRow}>
                <div className={styles.itemHeader}>
                  ...
                  <div className={styles.statsGroup}>
                    ...
                    <span className={styles.percentageBadge}>{adm.completionRate}% Done</span>
                  </div>
                </div>

                <div className={styles.barTrack}>
                  <div className={styles.barFill} style={{ width: `${adm.completionRate}%` }} />
                </div>
              </div>
            ))
