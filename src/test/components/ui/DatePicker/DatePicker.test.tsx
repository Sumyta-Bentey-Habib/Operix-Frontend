...
describe("DatePicker Component", () => {
  it("renders trigger button with placeholder or initial value", () => {
    render(<DatePicker range={{ startDate: "2026-06-29", endDate: "2026-08-29" }} mode="range" />);

    expect(screen.getByText("29 Jun 2026 - 29 Aug 2026")).toBeInTheDocument();
  });
  ...
  it("calls onChangeRange when a preset or range is chosen", () => {
    ...
    render(<DatePicker mode="range" onChangeRange={handleRangeChange} />);
