    ...
    <div className={styles.pageContainer}>
      ...
      <header className={styles.topNavHeader}>
        ...
        <div className={styles.topQuickPills}>
          <span className={styles.topRoleIndicator}>
            🌿 Pharmaceutical Operations & Governance
          </span>
        </div>
      </header>
      ...
      <main className={styles.mainHeroSection}>
        ...
        <p className={styles.heroDescription}>
          Join the next generation of pharmaceutical operations & healthcare
          management — where world-class medicine manufacturing meets intelligent
