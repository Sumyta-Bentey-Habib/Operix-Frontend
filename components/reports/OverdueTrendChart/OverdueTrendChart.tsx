  ...
  return (
    <div className={styles.card}>
      ...
      <svg className={styles.chartSvg} viewBox={`0 0 ${width} ${height}`}>
        <line x1={paddingX} y1={getY(15)} x2={width - paddingX} y2={getY(15)} className={styles.gridLine} />
        <line x1={paddingX} y1={getY(30)} x2={width - paddingX} y2={getY(30)} className={styles.gridLine} />
        <line x1={paddingX} y1={getY(45)} x2={width - paddingX} y2={getY(45)} className={styles.gridLine} />
